...
def load_all_data_mus():
    # http://www.culture.go.kr/openapi/rest/cultureartspaces/performingplace?serviceKey=ipA7GxlvIHVrsFJKg6yO%2FihFWarSbbwT%2BhG6ejOQMISeS9BSPgbgsf08SbC9qwgBEjJlzzj%2FyYMNMbFhrUZ09A%3D%3D&cPage=10&rows=1&RequestTime=20100810:23003422
    url = 'http://www.culture.go.kr/openapi/rest/cultureartspaces/museum'
    params = {'serviceKey': 'ipA7GxlvIHVrsFJKg6yO/ihFWarSbbwT+hG6ejOQMISeS9BSPgbgsf08SbC9qwgBEjJlzzj/yYMNMbFhrUZ09A==',
              'rows': '1000'}  # 한 페이지에 표시할 데이터 수를 설정합니다.
    file_path = 'datas/mus_data.xml'
...
def load_all_data_arts(): # todo 요거 돌려야함
    url = 'http://www.culture.go.kr/openapi/rest/cultureartspaces/artgallery'
    params = {'serviceKey': 'ipA7GxlvIHVrsFJKg6yO/ihFWarSbbwT+hG6ejOQMISeS9BSPgbgsf08SbC9qwgBEjJlzzj/yYMNMbFhrUZ09A==',
              'rows': '1000'}  # 한 페이지에 표시할 데이터 수를 설정합니다.
    file_path = 'datas/arts_data.xml'
...
def load_all_data_halls(): # todo 요거 돌려야함
    url = 'http://www.culture.go.kr/openapi/rest/cultureartspaces/hall'
    params = {'serviceKey': 'ipA7GxlvIHVrsFJKg6yO/ihFWarSbbwT+hG6ejOQMISeS9BSPgbgsf08SbC9qwgBEjJlzzj/yYMNMbFhrUZ09A==',
              'rows': '1000'}  # 한 페이지에 표시할 데이터 수를 설정합니다.
    file_path = 'datas/halls_data.xml'
...
def load_all_data_libs(): # todo 요거 돌려야함
    url = 'http://www.culture.go.kr/openapi/rest/cultureartspaces/library'
    params = {'serviceKey': 'ipA7GxlvIHVrsFJKg6yO/ihFWarSbbwT+hG6ejOQMISeS9BSPgbgsf08SbC9qwgBEjJlzzj/yYMNMbFhrUZ09A==',
              'rows': '1000'}  # 한 페이지에 표시할 데이터 수를 설정합니다.
    file_path = 'datas/libs_data.xml'
