...
key = 'sea100UMmw23Xycs33F1EQnumONR%2F9ElxBLzkilU9Yr1oT4TrCot8Y2p0jyuJP72x9rG9D8CN5yuEs6AS2sAiw%3D%3D'  #교수님꺼
TOKEN = '6524393122:AAGNCH0i1f6dOsYikapuhFQnwL-8x5lWwLc'   #우리꺼
MAX_MSG_LENGTH = 300
...
def getData(loc_param, date_param):
    ...
    for item in items:
        ...
        try:
            ...
            #위에 부분을 수정해줘야지 나오는 정보가 달라짐.
            row = parsed[6] + '/' + parsed[14] + '/' + parsed[9] + ', ' + parsed[10] + ' ' + parsed[5] + ', ' + parsed[
